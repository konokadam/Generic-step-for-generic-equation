...
module step_class
    ...
    abstract interface
        subroutine derivative_proc(self, t, h, x, xdot)
...
contains
    ...
    subroutine step_rk4(f, t, x, h, dx)
        ...
        call f%derivative(t, 0._rp, x, xdot1)           !!!1st RK4 step
        call f%derivative(t+ho2, ho2, x+ho2*xdot1, xdot2)   !!!2nd RK4 step
        call f%derivative(t+ho2 + ho2, x+ho2*xdot2, xdot3)   !!!3rd RK4 step
        call f%derivative(t+h, h, x+h*xdot3, xdot4)       !!!4th RK4 step
